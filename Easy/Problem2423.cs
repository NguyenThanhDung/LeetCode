public class Problem2423
{
    ...
    */
    ...
    public Problem2423()
    {
        ...
        Console.WriteLine(EqualFrequency("abcc") == true);          // {a:1, b:1, c:2}      -> {1:2, 2:1}       -> numOfFrequencies: 2  -> There is one count == 1  -> Its frequency > 1    -> Freq(count == 1) - Freq(Other) == 1  -> true
        Console.WriteLine(EqualFrequency("aaaabbbbccc") == false);  // {a:4, b:4, c:3}      -> {4:2, 3:1}       -> numOfFrequencies: 2  -> There is one count == 1  -> Its frequency > 1    -> Freq(count == 1) - Freq(Other) != 1  -> false
        Console.WriteLine(EqualFrequency("abccc") == false);        // {a:1, b:1, c:3}      -> {1:2, 3:1}       -> numOfFrequencies: 2  -> There is one count == 1  -> Its frequency > 1    -> Freq(count == 1) - Freq(Other) != 1  -> false
